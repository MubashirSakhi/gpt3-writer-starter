...
const generatePresentation = (slides, slideFont) => {
    ...
    for (let i = 0; i < slides.length; i++) {
        let fontSize = 18;
        if(slides[i].description !== undefined && slides[i].description.length > 700){
            fontSize = 12;
        }
        ...
        switch (slides[i].layout) {
            case 1: {
                ...
                slide.addText(slides[i].description, { x: 0.2, y: 1, w: 8, h: 4, margin: 1, fontSize: fontSize, fontFace: slideFont, valign: "top", align: "left"  });
                break;
            }
            case 2: {
                ...
                slide.addText(slides[i].description, { x: 1, y: 1.5, w: 8, h: 4, fontSize: fontSize, fontFace: slideFont, valign: "top", align: "center" });
            ...
            case 3: {
                ...
                slide.addText(slides[i].description, { x: 0.2, y: 1, w: 4.5, h: 4, margin: 1, fontSize: fontSize, fontFace: slideFont, valign: "top", align: "left" });
            ...
            case 4: {
                ...
                slide.addText(slides[i].description, { x: 1, y: 2, w: 8, h: 4, margin: 4, fontSize: fontSize, fontFace: slideFont, valign: "top", align: "center", color:"FFFFFF" });
            ...
            case 5: {
                ...
                slide.addText(slides[i].description, { x: 0.2, y: 1, w: 8, h: 4, margin: 1, fontSize: fontSize, fontFace: slideFont, valign: "top", align: "left",color:"FFFFFF" });
               // slide.background = { data: slides[i].image, transparency: 50 }; // image: base64 data
                break;
            }
            default: {
